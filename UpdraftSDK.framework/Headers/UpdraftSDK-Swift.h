...
@interface UIDevice (SWIFT_EXTENSION(UpdraftSDK))
...
SWIFT_CLASS("_TtC10UpdraftSDK7Updraft")
@interface Updraft : NSObject <UIGestureRecognizerDelegate>
+ (Updraft * _Nonnull)sharedInstance;
+ (void)with;
...
+ (void)returnFromUpdraftWithOpenURL:(NSURL * _Nonnull)url options:(NSDictionary<NSString *, id> * _Nonnull)options;
